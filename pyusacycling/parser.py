...
class BaseParser:
    ...
    def _save_to_cache(self, url: str, data: Dict[str, Any], expire_seconds: int = 3600) -> None:
        ...
        try:
            ...
            logger.warning(f"Error saving cache for {url}: {str(e)}")
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt < self.max_retries - 1:
                    ...
                    raise NetworkError(f"Failed to fetch {url} after {self.max_retries} attempts: {str(e)}")
    
    def _fetch_content(self, url: str, params: Optional[Dict[str, Any]] = None) -> str:
        """
        ...
        try:
            ...
            try:
                ...
                if "<html" in response.text.lower():
                    ...
                    raise ParseError(f"Failed to parse JSON from {url}: {str(e)}")
            ...
            if isinstance(e, (ParseError, NetworkError)):
                ...
                raise NetworkError(f"Failed to fetch JSON from {url}: {str(e)}")
    ...
    def _extract_load_info_id(self, onclick_text: str) -> Optional[str]:
        """
    ...
    def _extract_race_id(self, race_element_id: str) -> Optional[str]:
        """
...
class EventListParser(BaseParser):
    ...
    def get_events(self, state: str, year: int) -> List[Dict[str, Any]]:
        ...
        for event in events_data:
            ...
            if 'permit' in event and event['permit']:
...
class RaceResultsParser(BaseParser):
    ...
    def get_race_results(self, race_id: str, category_info: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
